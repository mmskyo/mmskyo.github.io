...
클라우드팀 연락 기다리기. 연락 오면 이것만 하면 돼요.

```
□ 로그인 테스트
□ 자동 로그인 확인 (앱 껐다 켜보기)
□ 로그아웃 최종 확인
□ feature/login → develop PR 올리기
```
...
□ 로그 목록 RecyclerView 연결

□ feature/logs → develop PR
```
...
□ 결과 화면에서 ★ 버튼으로 즐겨찾기 추가

□ 즐겨찾기 삭제

□ feature/favorites → develop PR
```
